...
import { FaqSeedEntry } from '../src/types/FaqSeedEntry';
...
const accountFaqs: FaqSeedEntry[] = [
  {
    ...
    answer:
      "Visit the signup page and fill in your basic information. You'll receive a confirmation email.",
  ...
  },
  {
    ...
    answer:
      "Check your spam folder and ensure you've entered a valid address. You can request a new one on the login screen.",
...
const loginFaqs: FaqSeedEntry[] = [
  ...
  },
  {
    ...
    answer:
      'Accounts lock after repeated failed login attempts. Wait 15 minutes or contact support to unlock.',
...
const troubleshootingFaqs: FaqSeedEntry[] = [
  ...
  },
  {
    ...
    answer:
      'Try refreshing your browser. If the issue persists, log out and back in. If unresolved, report a bug.',
    tags: ['crash', 'call', 'performance'],
  },
  {
    question: 'Why can’t I access my organization page?',
    answer:
      "Check that you're assigned to an active organization. Managers can update your access.",
    tags: ['organization', 'access', 'troubleshooting'],
  },
  {
    question: 'Notifications aren’t showing up.',
    answer:
      'Check browser permissions and confirm notification settings are enabled under your profile.',
...
const trainingFaqs: FaqSeedEntry[] = [
  {
    ...
    answer:
      'Training Mode simulates agent tasks with feedback. It’s perfect for new hires or refresher sessions.',
    tags: ['training', 'simulation', 'onboarding'],
  },
  {
    question: 'How do I mark a call as reviewed?',
    answer:
      'Use the ‘Mark Reviewed’ button at the end of the call log view. Managers can track completions.',
    tags: ['review', 'call', 'training'],
  },
  {
    question: 'Is there a guide for new agents?',
    answer:
      'Yes — access the Help Center tab and select ‘New Agent Guide’. It walks you through all key functions.',
